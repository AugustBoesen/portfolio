      ...
      <h1 className='header1'>Biography</h1>
        <div className='flex flex-col md:flex-row pt-6'>
          <div className='px-5'>
            ...
            Alongside several sub-genres of street dance and basics in contemporary & ballet, I have studied capoeira.</p>
            <p  className='text-left pt-2'>I have a passion for all things nerdy, including boffering, minifigure painting and TTRPGs.</p>
            <p className='text-left pt-2'>I have also done video editing and 3D rendering, including solo producing a music video for my instrumental song "vapauta". I have a Filmora license and have used it for video editing.</p>
            <h2 className='text-2xl mt-4'>GitHub Repository</h2>
            <p className='text-left pt-2'>You can freely inspect the code behind this website. Everything was made by yours truly for demonstrative purposes.</p>
          </div>
          <div className='px-5'>
            ...
            <p className='text-left pt-2'>Generally I am able to begin freelance work with a week's notice and my workflow allows me to execute such orders usually in a 1-5 tracks per day, if need be. Initially I can offer 4-6 hours per week of work towards any project, depending on scale and intensity.</p>
          </div>
        </div>
      </div>
    </div>
